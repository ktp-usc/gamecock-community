...
const ACTIVE_SESSION_KEY = "gcs-active-session";
...
export default function Home() {
  ...
  function handleClockIn() {
    if (!selectedName || activeSession) return;
  ...
  function handleClockOut() {
    ...
    if (activeSession.name !== selectedName) return;
  ...
  const canClockIn = Boolean(selectedName) && !activeSession;
  const canClockOut =
    Boolean(selectedName) && activeSession?.name === selectedName;
